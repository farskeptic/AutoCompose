...
namespace AutoCompose.Sample_20.Interfaces.Method.M02
{
    public interface ISampleM02
    {
        TOut Method1<TIn, TOut>(int nVal, bool bVal, string sVal, TIn sample) where TIn : new()
            where TOut : class, new();

        TOut Method2<TIn, TOut>(int nVal, bool bVal, string sVal, TIn sample) where TIn : new()
            where TOut : struct;
